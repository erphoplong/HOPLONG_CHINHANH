...
namespace ERP.Web.Areas.TruongAnHCM.Controllers
{
    ...
    public class HangHoaTAHCMController : Controller
    {
        ...
        {
            ViewBag.MA_NHOM_HANG = new SelectList(db.HH_NHOM_VTHH, "MA_NHOM_HANG", "TEN_NHOM_HANG");
        ...
        public ActionResult Create([Bind(Include = "MA_HANG_HT,MA_HANG_NHAP,TEN_HANG,MA_NHOM_HANG,SERI,DON_VI_TINH,MODEL_DAC_BIET,HINH_ANH,DAC_TINH,GHI_CHU,TK_HACH_TOAN_KHO,TK_DOANH_THU,TK_CHI_PHI")] HH dM_HANG_HOA)
        {
            if (ModelState.IsValid)
            {
                db.HHs.Add(dM_HANG_HOA);
                db.SaveChanges();
                return RedirectToAction("Index");
            }

            ViewBag.MA_NHOM_HANG = new SelectList(db.HH_NHOM_VTHH, "MA_NHOM_HANG", "TEN_NHOM_HANG", dM_HANG_HOA.MA_NHOM_HANG);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MA_HANG_HT,MA_HANG_NHAP,TEN_HANG,MA_NHOM_HANG,SERI,DON_VI_TINH,MODEL_DAC_BIET,HINH_ANH,DAC_TINH,GHI_CHU,TK_HACH_TOAN_KHO,TK_DOANH_THU,TK_CHI_PHI")] HH dM_HANG_HOA)
        {
            if (ModelState.IsValid)
            {
